 ...
 * 
 */
public class PreviousMonthEndDate extends CustomJavaAction<java.util.Date>
{
	public PreviousMonthEndDate(IContext context)
	{
		super(context);
	}
	...
	public java.util.Date executeAction() throws Exception
	{
		...
		Date PreviousMonthLastDay = calendar.getTime();
