 ...
 * 
 */
public class PreviousMonthStartDate extends CustomJavaAction<java.util.Date>
{
	public PreviousMonthStartDate(IContext context)
	{
		super(context);
	}
	...
	public java.util.Date executeAction() throws Exception
	{
		...
		Date PreviousMonthFirstDay = calendar.getTime();
