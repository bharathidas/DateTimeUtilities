...
/**
 * Get Month Start date from Month and Year
 * 
 * Example:
 * Year:2021
 * Month:2(Feburary)
 */
public class MonthStartDate extends CustomJavaAction<java.util.Date>
{
	private java.lang.Long Year;
	private java.lang.Long Month;

	public MonthStartDate(IContext context, java.lang.Long Year, java.lang.Long Month)
	{
		super(context);
		this.Year = Year;
		this.Month = Month;
